...
for detector in [infection_detector]:
    ...
    for seq2seq in [infection_seq2seq]:
        ...
        for r in range(args.relabel_rounds):
            ...
            print(f">>>>>>>> Prepare {r} round Retraining dataset >>>>>>>>")    
            ...
            """
            retrain_cle_set_x = np.concatenate((retrain_cle_testset_x,retrain_cle_trainset_x))
            retrain_cle_set_y = np.concatenate((retrain_cle_testset_y,retrain_cle_trainset_y))            
            ...
            print(f">>>>>>>> {r} round Retraining {detector.modelname} >>>>>>>>")    
            ...
            print(f">>>>>>>> Evaluate {r} round retrained {detector.modelname} on clean test data")
            ...
            print(f">>>>>>>> Evaluate {r} round retrained {detector.modelname} on adversarial test data")
            ...
            print(f"{r}th-round retrained {detector.modelname} adv_metrics_dic:\n {adv_metrics_dic}")    
