...
norm_multistep_dataset = normalize_multistep_dataset(multistep_dataset)

# ----------------create per-step detectors----------------------
attack_detector, reconnaissance_detector, infection_detector = init_psdetector(norm_multistep_dataset, args)
...
for detector in [attack_detector, reconnaissance_detector, infection_detector]:
    ...
    test_acc, test_los, test_TP, test_FP, test_TN, test_FN, test_recall, test_precision, test_FPR, test_F1 = detector.test(timesteps=args.timesteps, exp_result_dir=exp_result_dir)
...
for detector in [attack_detector, reconnaissance_detector, infection_detector]:
    ...
    # adv_test_examples, adv_test_labels = detector.generate_advmail(timesteps=args.timesteps, exp_result_dir=exp_result_dir)
