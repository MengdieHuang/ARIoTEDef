...
for detector in [infection_detector]:
    ...
    for seq2seq in [infection_seq2seq]:
        ...
        if args.advset_mode == 'advset1':
            ...
            detector_infer_time_list=[]
            s2sanalyzer_infer_time_list=[]
            #---------------------------------------------
            #
            ...
            for r in range(args.relabel_rounds):
                ...
                adv_testset_x, adv_testset_y = detector.generate_advmail(timesteps=args.timesteps,cle_testset_x=detector.dataset['test'][0],cle_testset_y=detector.dataset['test'][1])  # detector有更新吗 yes
                ...
                if args.retrain_testset_mode == 'cle_adv':
                    ...
                    print("only input adv to ARIoTEDef")
                ...
                # >>> per-step infection detector running time
                ...
                detector_tagged_mal_windows_probs, detector_tagged_mal_windows_idxs, detector_tagged_ben_windows_probs,detector_tagged_ben_windows_idxs, detector_infer_time = detector.analysis(test_windows_x)
                detector_infer_time_list.append(detector_infer_time)
                ...
                seq2seq_tagged_mal_event_probs, seq2seq_tagged_mal_event_idxs, seq2seq_tagged_ben_event_probs, seq2seq_tagged_ben_event_idxs,s2sanalyzer_infer_time = seq2seq.analysis(test_events_x, test_windows_y) # seq2seq 有更新吗 No
                
                s2sanalyzer_infer_time_list.append(s2sanalyzer_infer_time)
            ...
            #----------20240130-----------
            detector_infer_time_png_name = f'Cost Time of {detector.modelname} Predict Test Windows'
            s2sanalyzer_infer_time_png_name = f'Cost Time of Sequency Analyzer Predict Test Events'
            ...
            # 20240130
            plt.plot(list(range(len(detector_infer_time_list))), detector_infer_time_list, label='Cost Time', marker='o')
            plt.xlabel('Round')
            plt.ylabel('Cost Time (second)')
            plt.xticks(range(min(list(range(len(detector_infer_time_list)))), max(list(range(len(detector_infer_time_list))))+1, math.ceil(len(detector_infer_time_list)/10)))       
            plt.xlim(left=0)
            plt.ylim(bottom=0) 
            # plt.legend()
            plt.title(f'{detector_infer_time_png_name}')        
            plt.savefig(f'{retrain_cle_exp_result_dir}/{detector_infer_time_png_name}.png')
            plt.close()
            
            # 20240130
            plt.plot(list(range(len(s2sanalyzer_infer_time_list))), s2sanalyzer_infer_time_list, label='Cost Time', marker='o')
            plt.xlabel('Round')
            plt.ylabel('Cost Time (second)')
            plt.xticks(range(min(list(range(len(s2sanalyzer_infer_time_list)))), max(list(range(len(s2sanalyzer_infer_time_list))))+1, math.ceil(len(s2sanalyzer_infer_time_list)/10)))       
            plt.xlim(left=0)
            plt.ylim(bottom=0) 
            # plt.legend()
            plt.title(f'{s2sanalyzer_infer_time_png_name}')        
            plt.savefig(f'{retrain_cle_exp_result_dir}/{s2sanalyzer_infer_time_png_name}.png')
            plt.close()            
            ...
            pd.DataFrame(detector_infer_time_list).to_excel(f'{cle_figure_xlsx_result_dir}/detector_infer_time_list.xlsx')      
            pd.DataFrame(s2sanalyzer_infer_time_list).to_excel(f'{cle_figure_xlsx_result_dir}/s2sanalyzer_infer_time_list.xlsx')      
                
            # raise Exception("finish retrain in adversarial setting 1")
            ...
            # Original clean test set lengh: 4233
            ...
            malicious_cle_testset_y: [1. 1. 1. 1. 1. 1. 1
            """
            ...
            """ 
            benign_cle_testset_y.shape: (3915,)
            benign_cle_testset_y: [0. 0. 0. ... 0. 0. 0.]
            """        
            ...
            # print("benign_cle_testset_x.shape:",benign_cle_testset_x.shape)          
            """ 
            benign_cle_testset_x.shape: (3915, 41)
            """
            ...
            for i in range(args.relabel_rounds+1):
                ...
                # print(f"sub_mal_cle_testsets_x[{i}].shape:{sub_mal_cle_testsets_x[i].shape}")
                # print(f"sub_mal_cle_testsets_y[{i}].shape:{sub_mal_cle_testsets_y[i].shape}")
                """ 
                Number of mal samples in 1 sub_mal_cle_testset - : 159
                sub_mal_cle_testsets_x[0].shape:(159, 41)
                sub_mal_cle_testsets_y[0].shape:(159,)
                """
            ...
            for i in range(args.relabel_rounds+1):
                ...
                # print(f"sub_ben_cle_testsets_x[{i}].shape:{sub_ben_cle_testsets_x[i].shape}")
                # print(f"sub_ben_cle_testsets_y[{i}].shape:{sub_ben_cle_testsets_y[i].shape}")  
                """ 
                Number of ben samples in 1 sub_ben_cle_testset - : 1957
                sub_ben_cle_testsets_x[0].shape:(1957, 41)
                sub_ben_cle_testsets_y[0].shape:(1957,)
                """    
            ...
            for i in range(args.relabel_rounds+1):
                ...
                # print("subdataset_y:",subdataset_y)
                ...
                # print(f"sub_cle_testsets_x[{i}].shape:{sub_cle_testsets_x[i].shape}")
                # print(f"sub_cle_testsets_y[{i}].shape:{sub_cle_testsets_y[i].shape}")                
                
                """
                Number of samples in 1 sub_cle_testset - : 2116
                sub_cle_testsets_x[0].shape:(2116, 41)
                sub_cle_testsets_y[0].shape:(2116,)
                """  
            ...
            for r in range(args.relabel_rounds):
                ...
                print("cle_test_y.shape:",cle_test_y.shape)
                """ 
                cle_test_x.shape: (2116, 41)
                cle_test_y.shape: (2116,)
                """
                ...
                # adv_testset_x, adv_testset_y = detector.generate_advmail(timesteps=args.timesteps)  # detector有更新吗 yes
                adv_testset_x, adv_testset_y = detector.generate_advmail(timesteps=args.timesteps,cle_testset_x=sub_cle_testsets_x[r], cle_testset_y=sub_cle_testsets_y[r])  # detector有更新吗 yes
                
                
                print("adv_testset_x.shape:",adv_testset_x.shape)    
                print("adv_testset_y.shape:",adv_testset_y.shape)    
                """ 
                adv_testset_x.shape: (159, 41)
                adv_testset_y.shape: (159,)
                """               
                ...
                if args.retrain_testset_mode == 'cle_adv':
                    ...
                    print("retrain_test_(adv)_y.shape:",test_y.shape)   
                    """ 
                    retrain_test_(adv)_x.shape: (159, 41)
                    retrain_test_(adv)_y.shape: (159,)
                    """
            ...
            #------------------------clean plt换成bar---------------
            # plt.bar(list(range(len(test_los_list))), test_los_list, label='Test Loss')
            ...
            #-----------special----------        
            # plt.bar(list(range(len(test_acc_list))), test_acc_list, label='Test Accuracy')
            ...
            # plt.plot(list(range(len(test_FN_list))), test_FN_list, label='Test FN', marker='s')
            # bar_width = 0.2  
            # x_positions = np.arange(len(test_FP_list))

            # fig, ax = plt.subplots()
            # bar1 = ax.bar(x_positions - bar_width/2, test_FP_list, bar_width, label='Test FP')
            # bar2 = ax.bar(x_positions + bar_width/2, test_FN_list, bar_width, label='Test FN') 
            ...
            # bar_width = 0.2  
            # x_positions = np.arange(len(test_FPrate_list))

            # fig, ax = plt.subplots()
            # bar1 = ax.bar(x_positions - bar_width/2, test_FPrate_list, bar_width, label='Test FP rate')
            # bar2 = ax.bar(x_positions + bar_width/2, test_FNrate_list, bar_width, label='Test FN rate') 
            ...
            # plt.bar(list(range(len(test_recall_list))), test_recall_list, label='Test Recall')
            ...
            # plt.bar(list(range(len(test_F1_list))), test_F1_list, label='Test F1')
            ...
            raise Exception("finish retrain in adversarial setting 2")

        else:
            print("advset_mode is None. No retrain!")
