...
for detector in [infection_detector]:
    ...
    for seq2seq in [infection_seq2seq]:
        ...
        plt.xticks(range(min(list(range(len(test_los_list)))), max(list(range(len(test_los_list))))+1, int(len(test_los_list)/10)))
        plt.xlim(left=0)
        plt.ylim(bottom=0)
        # plt.legend()
        ...
        plt.xticks(range(min(list(range(len(test_acc_list)))), max(list(range(len(test_acc_list))))+1, int(len(test_acc_list)/10)))
        plt.ylim(0, 100)
        plt.xlim(left=0)
        plt.ylim(bottom=0)
        # plt.legend()
        ...
        plt.xticks(range(min(list(range(len(cost_time_list)))), max(list(range(len(cost_time_list))))+1, int(len(cost_time_list)/10)))       
        plt.xlim(left=0)
        plt.ylim(bottom=0) 
        # plt.legend()
        ...
        plt.xticks(range(min(list(range(len(test_FP_list)))), max(list(range(len(test_FP_list))))+1, int(len(test_FP_list)/10)))        
        plt.xlim(left=0)
        plt.ylim(bottom=0)
        ...
        plt.xticks(range(min(list(range(len(test_FPrate_list)))), max(list(range(len(test_FPrate_list))))+1, int(len(test_FPrate_list)/10))  )   
        plt.xlim(left=0)
        plt.ylim(bottom=0)   
        plt.legend(loc='best',frameon=True)
        ...
        plt.xticks(range(min(list(range(len(test_recall_list)))), max(list(range(len(test_recall_list))))+1, int(len(test_recall_list)/10))  )   
        plt.xlim(left=0)
        plt.ylim(bottom=0)   
        # plt.legend()
        ...
        plt.xticks(range(min(list(range(len(test_F1_list)))), max(list(range(len(test_F1_list))))+1, int(len(test_F1_list)/10))   ) 
        plt.xlim(left=0)
        plt.ylim(bottom=0)            
        # plt.legend()
        ...
        plt.xticks(range(min(list(range(len(adv_test_los_list)))), max(list(range(len(adv_test_los_list))))+1, int(len(adv_test_los_list)/10))   )  
        plt.xlim(left=0)
        plt.ylim(bottom=0)           
        # plt.legend()
        ...
        plt.xticks(range(min(list(range(len(adv_test_acc_list)))), max(list(range(len(adv_test_acc_list))))+1, int(len(adv_test_acc_list)/10))     )
        plt.xlim(left=0)
        plt.ylim(bottom=0)                     
        # plt.legend()
        ...
        plt.xticks(range(min(list(range(len(adv_test_FN_list)))), max(list(range(len(adv_test_FN_list))))+1, int(len(adv_test_FN_list)/10)))                
        plt.xlim(left=0)
        plt.ylim(bottom=0)  
        # plt.legend()
        ...
        plt.xticks(range(min(list(range(len(adv_test_FNrate_list)))), max(list(range(len(adv_test_FNrate_list))))+1, int(len(adv_test_FNrate_list)/10)) )      
        plt.xlim(left=0)
        plt.ylim(bottom=0)                   
        # plt.legend()
        ...
        plt.xticks(range(min(list(range(len(adv_test_recall_list)))), max(list(range(len(adv_test_recall_list))))+1, int(len(adv_test_recall_list)/10))    )
        plt.xlim(left=0)
        plt.ylim(bottom=0)                      
        # plt.legend()
        ...
        plt.xticks(range(min(list(range(len(adv_test_F1_list)))), max(list(range(len(adv_test_F1_list))))+1, int(len(adv_test_F1_list)/10))      )                        
        plt.xlim(left=0)
        plt.ylim(bottom=0)            
        # plt.legend()
