...
#     adv_test_acc, adv_test_los, adv_test_TP, adv_test_FP, adv_test_TN, adv_test_FN, adv_test_recall, adv_test_precision, adv_test_F1 = detector.test(testset_x=adv_testset_x, testset_y=adv_testset_y, timesteps=args.timesteps, exp_result_dir=adv_exp_result_dir)
...
# print("infection_seq2seq.model:",infection_seq2seq.model)

# infection_seq2seq.model.summary()
...
for seq2seq in [infection_seq2seq]:
    ...
    if args.stdtrain_seq2seq is True:
        ...
        seq2seq.stdtrain_2(events=seq2seq_train_events, labels=cle_train_windows_y, exp_result_dir=stdtrain_exp_result_dir)
        ...
        """        
        test_acc, test_los, test_TP, test_FP, test_TN, test_FN, test_recall, test_precision, test_F1 = seq2seq.test(testset_x=seq2seq_test_events, testset_y=cle_test_windows_y, exp_result_dir=stdtrain_exp_result_dir)
        ...
        # seq2seq.load_model(args.seq2seq_model_path)        
        
        test_acc, test_los, test_TP, test_FP, test_TN, test_FN, test_recall, test_precision, test_F1 = seq2seq.test(testset_x=seq2seq_test_events, testset_y=cle_test_windows_y, exp_result_dir=pretrain_exp_result_dir)
...
for detector in [infection_detector]:
    ...
    for seq2seq in [infection_seq2seq]:
        ...
        test_acc, test_los, test_TP, test_FP, test_TN, test_FN, test_recall, test_precision, test_F1 = detector.test(testset_x=detector.dataset['test'][0], testset_y=detector.dataset['test'][1],timesteps=args.timesteps, exp_result_dir=exp_result_dir)
        ...
        for r in range(args.relabel_rounds):
            ...
            test_acc, test_los, test_TP, test_FP, test_TN, test_FN, test_recall, test_precision, test_F1 = detector.test(testset_x=detector.dataset['test'][0], testset_y=detector.dataset['test'][1],timesteps=args.timesteps, exp_result_dir=curround_exp_result_dir)
