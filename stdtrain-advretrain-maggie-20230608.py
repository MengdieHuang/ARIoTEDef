...
for seq2seq in [infection_seq2seq]:
    ...
    if args.stdtrain_seq2seq is True:
        ...
        """        
        test_acc, test_los, test_TP, test_FP, test_TN, test_FN, test_recall, test_precision, test_F1 = seq2seq.test(events=seq2seq_test_events, labels=cle_test_windows_y, exp_result_dir=stdtrain_exp_result_dir)
        ...
        test_acc, test_los, test_TP, test_FP, test_TN, test_FN, test_recall, test_precision, test_F1 = seq2seq.test(events=seq2seq_test_events, labels=cle_test_windows_y, exp_result_dir=pretrain_exp_result_dir)
